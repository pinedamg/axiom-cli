...
- `-d, --dev`: Habilita el Modo Laboratorio para Desarrolladores (Trazado de Decisiones).
...
### `axiom dev <args>...`
Ejecuta un comando en Modo Laboratorio para Desarrolladores (Trazado de Decisiones).

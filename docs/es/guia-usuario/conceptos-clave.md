...
| Nivel | Comando / Flag | Procesamiento | Ideal para... |
| :--- | :--- | :--- | :--- |
...
| **FUZZY** | `axiom intent enable fuzzy` | Palabras clave + Contexto Git | Desarrollo estándar. Filtra el ruido basado en relevancia. |

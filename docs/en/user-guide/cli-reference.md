...
- `--dev`: Enables Developer Laboratory Mode (Decision Tracing), useful for debugging the semantic matching logic.
...
- **Arguments**:
  - `args`: The command to execute (e.g., `axiom dev ls -al`).

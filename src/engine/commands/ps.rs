...
impl CommandHandler for PsHandler {
    ...
    fn generate_insight(&self, _command: &str, buffer: &DiscoveryBuffer) -> Option<String> {
        let mut max_cpu = 0.0;
        // ⚡ Bolt: Usamos Option<&str> en lugar de String para top_proc.
        // Esto permite referenciar los datos del DiscoveryBuffer directamente,
        // evitando múltiples clones del String dentro de la iteración.

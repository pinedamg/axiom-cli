    ...
    fn process(&mut self, chunk: &[u8]) -> Vec<TerminalEvent> {
        ...
        for c in stripped.chars() {
            if c == '\n' {
                ...
                // ⚡ Bolt: Usamos clone() y clear() en lugar de std::mem::take() para preservar la
                // capacidad pre-asignada (1024 bytes) del buffer, evitando reasignaciones constantes en el heap.
